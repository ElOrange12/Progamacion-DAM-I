...
INPUT_HTML = Path("/mnt/data/guardado.html")  # cambia si tu guardado.html está en otra ruta
...
def decode_js_jsonparse_string(s: str) -> Optional[str]:
    """
    s es el contenido entre comillas de JSON.parse("...").
    Lo decodificamos como literal JSON (envolviéndolo en comillas) para des-escapar \" \n \uXXXX, etc.
    """
    try:
