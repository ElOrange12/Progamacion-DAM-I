...
<html>
	<head>
		<style>
			...
			body{display:flex;}
			nav{flex:1;background:coral;color:white;display:flex;flex-direction:column;gap:10px;padding:10px;}
			...
			main form{flex:1;display:flex;flex-direction:column;gap:10px;border:2px solid coral;padding:10px;}
		</style>
	</head>
	<body>
	</body>
